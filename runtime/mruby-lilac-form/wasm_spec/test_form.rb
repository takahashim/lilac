# Specs for Lilac::Form. Each test mounts a Component that uses the
...
Spec.describe "Lilac::Form: field state" do
  Spec.assert "base_error starts as nil" do
    ...
    Lilac.register "form-base-init", klass
    Lilac.start

    el = doc.call(:querySelector, "[data-component='form-base-init']")
    fm = Lilac.find_for_element(el)._form
  ...
  Spec.assert "initial value reflected in input via 2-way binding" do
    ...
    Lilac.register "form-init", klass
    Lilac.start
  ...
  Spec.assert "dirty? latches true after input differs from initial" do
    ...
    Lilac.register "form-dirty", klass
    Lilac.start
  ...
  Spec.assert "touched? is false until blur, then true" do
    ...
    Lilac.register "form-touch", klass
    Lilac.start
...
Spec.describe "Lilac::Form: validation" do
...
Spec.describe "Lilac::Form: submit" do
  Spec.assert "submit clears existing base_error before validation" do
    ...
    Lilac.register "form-sub-base-clear", klass
    Lilac.start
  ...
  Spec.assert "submit on invalid form does NOT call block, marks all touched" do
    ...
    Lilac.register "form-sub-bad", klass
    Lilac.start
  ...
  Spec.assert "submit on valid form calls block with values hash" do
    ...
    Lilac.register "form-sub-ok", klass
    Lilac.start
  ...
  Spec.assert "submit_attempted? becomes true after submit, cleared by reset" do
    ...
    Lilac.register "form-sub-att", klass
    Lilac.start
...
Spec.describe "Lilac::Form: reset" do
  Spec.assert "set_base_error and clear_base_error update form-level error" do
    ...
    Lilac.register "form-base-set", klass
    Lilac.start
  ...
  Spec.assert "reset restores initial value and clears dirty?/touched?" do
    ...
    Lilac.register "form-reset", klass
    Lilac.start
...
Spec.describe "Lilac::Form: server errors" do
...
Spec.describe "Lilac::Form: checkbox type" do
...
Spec.describe "Lilac::Form: multiple forms per component" do
  Spec.assert "two forms in one component are independent" do
    ...
    Lilac.register "form-multi", klass
    Lilac.start
...
Spec.describe "Lilac::Form: fields enumeration" do
  Spec.assert "fields hash exposes all declared fields by Symbol key" do
    ...
    Lilac.register "form-enum", klass
    Lilac.start
