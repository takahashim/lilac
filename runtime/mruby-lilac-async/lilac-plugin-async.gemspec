...
Gem::Specification.new do |spec|
  spec.name = "lilac-plugin-async"
  spec.version = "0.1.0"
  spec.authors = ["takahashim"]

  spec.summary = "Lilac plug-in: async data primitives (Fetchy, Lilac::Resource, selector helpers)"
  ...
  # See lilac-plugin-extras.gemspec for the mrblib source distribution
  # rationale.
