...
class TestCodegen < Minitest::Test
  ...
  def test_emits_namespaced_module_and_include
    ...
    assert_includes out, "Counter.include(Lilac::Bindings::Counter)"
  end
  ...
  def test_kebab_component_name_becomes_pascalcase
    ...
    assert_includes out, "Lilac::Bindings::UserProfile"
    assert_includes out, "UserProfile.include(Lilac::Bindings::UserProfile)"
  end
  ...
  def test_double_dash_creates_namespace
    ...
    assert_includes out, "Admin::UserCard.include(Lilac::Bindings::Admin::UserCard)"
  end
