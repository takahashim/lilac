...
module Grainet
  module CLI
    ...
    class Config
      ...
      attr_reader :root, :widgets_dir, :pages_dir, :output_dir, :public_dir,
                  :dev_host, :dev_port
      ...
      def self.load(root: nil, widgets_dir: nil, pages_dir: nil, output_dir: nil,
        ...
        new(
          root: resolved_root,
          widgets_dir: widgets_dir || settings.widgets_dir,
      ...
      def initialize(root: nil, widgets_dir: nil, pages_dir: nil, output_dir: nil,
                     public_dir: nil, dev_host: nil, dev_port: nil)
        ...
        @widgets_dir = expand(widgets_dir || DEFAULT_WIDGETS_DIR)
