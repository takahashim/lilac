...
背景は [ADR-0015](./adr/0015-lilac-full-bundle-size-optimization.md) /
[ADR-0017](./adr/0017-codegen-canonical-scanner-grammar-only.md) を参照。
...
- [ADR-0015](./adr/0015-lilac-full-bundle-size-optimization.md)(`lilac-full` の bundle size 最適化)
- [ADR-0017](./adr/0017-codegen-canonical-scanner-grammar-only.md)(binding canonical = codegen、scanner = grammar reference)
